...
export const PATH_USER_PROFILE = `${PATH_PROFILE_BASE}?tab=:tab&page=:page`;
...
export const defaultProfileTab = ProfileTab.owned;
...
export const ProfileRoutesConfig: { [key: string]: RouteConfiguration } = {
  ...
  UserProfile: {
    ...
    generatePath: (tab?: ProfileTab, page?: string) =>
