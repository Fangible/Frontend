...
import { TabCreated } from './components/TabCreated';
...
export const Profile = () => {
  ...
  const onTabsChange = useCallback(
    (_, value) => {
      push(ProfileRoutesConfig.UserProfile.generatePath(value, 1));
      updateData(value);
    },
    [push, updateData],
  );
  ...
  return (
    <Section className={classes.root}>
      ...
      <Container>
        ...
        <TabPanel value={tab} index={ProfileTab.created}>
          <TabCreated reload={reload(ProfileTab.created)} />
        </TabPanel>
