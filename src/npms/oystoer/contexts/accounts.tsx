...
export const getMintInfo = async (
  ...
  console.log('getMintInfo start---->', pubKey.toBase58());
  const info = await connection.getAccountInfo(pubKey);
  console.log('info getAccountInfo---->', info);
  if (info === null) {
    console.error('Failed to find mint account');
...
const UseNativeAccount = () => {
  ...
  const { account: publicKey } = useReactWeb3();
